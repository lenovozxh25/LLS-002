            ...
            >
              <div class="session" v-if="item.id==1">
                <div class="videoPlay">
                  ...
                  <!-- <video id='myvideo'
                      ...
                      autoplay="autoplay"
                    >
                    <source v-show="index===curId" type="application/x-mpegURL" v-for="(item,index) in MyMaterialDetailsData" :key='index' :src="item.fileWebUrl" >
                       <source src="http://10.119.129.135:8080/customMaterials\175078a4-d7a1-4737-a81e-0b8a8be85da4.mp4" type="application/x-mpegURL">
                  </video>-->
                ...
                <div class="videoList">
                  <div>
                    <h3>
                      ...
                      >
                        ...
                        <path
                          ...
                          p-id="1142"
                        />
                        <path d="M192 224a32 32 0 0 1 64 0v544a32 32 0 0 1-64 0z" p-id="1143" />
                        <path
                    ...
                    <ul class="videoListItem" style="cursor: pointer;">
                      <li
                        @click="tab(index,item.fileWebUrl)"
                        :class="{active : index===curId}"
                        v-for="(item,index) in MyMaterialDetailsData"
                        :key="index"
                      >
                        <a style="font-size:14px">{{item.fileName}}</a>
                        <!-- <a href="#">{{item.fileWebUrl}}</a> -->
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <template v-else>
                <el-table :data="MyMaterialDetailsData" style="width: 100%">
                  ...
                  <el-table-column prop="fileAuthor" label="作者" width="180"></el-table-column>
